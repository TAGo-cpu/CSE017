/**
 * this is a class for linkedlist which implements a heap algorithm to sort the list
 * @author Takeru Hiura
...
public class LinkedList<E> {
    public static int containsIterations, removeIterations, addIterations, sortIterations;
    // Data members
    ...
    */
     ...
     */
      public void sort(Comparator<E> comp){
        ...
        Iterator<E> iter = this.iterator();
        while(iter.hasNext()){ //n iterations 
          sortIterations++;
          heap.add(iter.next()); //log(n)

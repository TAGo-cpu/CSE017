...
public abstract class Title implements Comparable<Title>, Cloneable, Restorable {
    ...
    /**
     * this is a method that is overridden used to compare the years of two titles
     */
    @Override
    ...
    /**
     * this method creates a shallow clone of the object it is called with 
     */
    public Object clone(){
        return this;
    ...
    /**
     * this is a method to check if the age of a title object is greater than equal to 50 and will return true if so, if not it returns false
     */
    public boolean isRestorable(){
        if((LocalDate.now().getYear() - year) >= 50){
            return true;
        }else{
            return false;
        }
